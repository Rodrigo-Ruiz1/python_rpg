...
def main():
    ...
    while green_knight.health > 0 and gawain.health > 0:
        print("You have %d health and %d power." % (gawain.health, gawain.power))
        print("The goblin has %d health and %d power." % (green_knight.health, green_knight.power))
        print()
        ...
        if user_input == "1":
            # Hero attacks goblin
            green_knight.health -= gawain.power
